...
lista1:list = [1, 0, 1, 0, 1, 1, 0, 0]
#lista1:list = ["Pepito", "Pepita", "Juancito"]
...
# Crear una lista a partir de un array e imprimirla
lista3:list  = list(array3) 
print("Creo una lista3 a partir de array3: " + str(lista3))
